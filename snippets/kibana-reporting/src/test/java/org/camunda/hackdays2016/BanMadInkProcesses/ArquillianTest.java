...
public class ArquillianTest {
  ...
  private static final String PROCESS_DEFINITION_KEY = "BanMadInkProcesses";
  ...
  public static WebArchive createDeployment() {
    ...
    return ShrinkWrap
            .create(WebArchive.class, "BanMadInkProcesses.war")
            ...
            .addPackages(false, "org.camunda.hackdays2016.BanMadInkProcesses") // not recursive to skip package 'nonarquillian'
