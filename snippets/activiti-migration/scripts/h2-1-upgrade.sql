...
create index ACT_IDX_METER_LOG on ACT_RU_METER_LOG(NAME_,TIMESTAMP_);alter table ACT_HI_JOB_LOG
  alter column ACT_ID_ varchar(255);
...
ALTER TABLE ACT_RU_JOB
  alter column PROCESS_DEF_KEY_ varchar(255);-- https://app.camunda.com/jira/browse/CAM-5364 --
...
ALTER TABLE ACT_RU_JOB
  alter column PROCESS_DEF_KEY_ varchar(255);-- semantic version --
