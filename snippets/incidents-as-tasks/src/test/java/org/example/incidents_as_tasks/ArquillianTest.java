...
public class ArquillianTest {
  ...
  private static final String PROCESS_DEFINITION_KEY = "incidents-as-tasks";
  ...
  public static WebArchive createDeployment() {
    ...
    return ShrinkWrap
            .create(WebArchive.class, "incidents-as-tasks.war")
            ...
            .addPackages(false, "org.example.incidents_as_tasks") // not recursive to skip package 'nonarquillian'
