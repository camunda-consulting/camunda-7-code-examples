...
public class ArquillianTest {
  ...
  public static WebArchive createDeployment() {
    ...
    return ShrinkWrap
            .create(WebArchive.class, "asynchronous-messaging-jms.war")
            ...
            .addPackages(false, "org.camunda.bpm.example.asynchronous_messaging_jms") // not recursive to skip package 'nonarquillian'
