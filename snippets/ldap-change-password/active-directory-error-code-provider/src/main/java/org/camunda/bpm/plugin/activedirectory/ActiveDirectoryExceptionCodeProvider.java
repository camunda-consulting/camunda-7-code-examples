...
public class ActiveDirectoryExceptionCodeProvider implements ExceptionCodeProvider {
  ...
  private static final Logger LOG =
      LoggerFactory.getLogger(ActiveDirectoryExceptionCodeProvider.class);
  ...
  public Integer provideCode(ProcessEngineException processEngineException) {
    ...
    LOG.debug("ActiveDirectoryErrorCodeProviderPlugin got exception with cause: {}", cause.getClass());
    LOG.debug("ActiveDirectoryErrorCodeProviderPlugin got message: {}", message);
