...
public class ArquillianTest {
  ...
  public static WebArchive createDeployment() {
    ...
    return ShrinkWrap
            .create(WebArchive.class, "embedded-engine-without-spring.war")
            ...
            .addPackages(false, "com.camunda.demo.embedded_engine_without_spring") // not recursive to skip package 'nonarquillian'
