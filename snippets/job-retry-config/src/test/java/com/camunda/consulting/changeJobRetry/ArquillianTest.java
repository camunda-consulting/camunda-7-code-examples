...
public class ArquillianTest {
  ...
  private static final String PROCESS_DEFINITION_KEY = "job-retry-config";
  ...
  public static WebArchive createDeployment() {
    ...
    return ShrinkWrap
            .create(WebArchive.class, "job-retry-config.war")
            ...
            .addPackages(false, "com.camunda.consulting.job_retry_config") // not recursive to skip package 'nonarquillian'
