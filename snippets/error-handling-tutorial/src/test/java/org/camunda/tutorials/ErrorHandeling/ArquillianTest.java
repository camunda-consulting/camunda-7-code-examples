...
public class ArquillianTest {
  ...
  private static final String PROCESS_DEFINITION_KEY = "ErrorHandeling";
  ...
  public static WebArchive createDeployment() {
    ...
    return ShrinkWrap
            .create(WebArchive.class, "ErrorHandeling.war")
            ...
            .addPackages(false, "org.camunda.tutorials.ErrorHandeling") // not recursive to skip package 'nonarquillian'
