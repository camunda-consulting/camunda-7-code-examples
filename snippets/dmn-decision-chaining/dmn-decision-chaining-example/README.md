...
<!-- HTML snippet for index page
  <tr>
    <td><img src="snippets/dmn-decision-chaining/src/main/resources/process.png" width="100"></td>
    <td><a href="snippets/dmn-decision-chaining">Camunda BPM Process Application</a></td>
