 ...
 *
 * <ul>
 *   <li>for attributes of type {@link String}, the string <strong>$null$</strong> is reserved and
 *       used as default value
 *   <li>for attributes of type {@link Long}, the value {@link Long#MIN_VALUE} is reserved and used
 *       as default value
 */
@Target({TYPE, METHOD})
@Retention(RUNTIME)
...
public @interface ExternalTaskSubscription {
   ...
   *       <li>{@code false}: topic subscription can be opened after application start by {@link
  ...
  /**
   * @return localVariables whether or not variables from greater scope than the external task
   *     should be fetched. <code>false</code> means all variables visible in the scope of the
   *     external task will be fetched, <code>true</code> means only local variables (to the scope
   *     of the external task) will be fetched
   */
  ...
  /**
   * @return processDefinitionKeyIn to filter for external tasks that are supposed to be fetched and
   *     locked
   */
  ...
  /**
   * @return processVariables of which the external tasks to be retrieved are related to. Each value
   *     is instance of {@link ProcessVariable}
   */
  ProcessVariable[] processVariables() default {
    @ProcessVariable(name = STRING_NULL_VALUE, value = STRING_NULL_VALUE)
  };
  ...
  /**
   * @return includeExtensionProperties whether to include custom extension properties for fetched
   *     external tasks. <code>true</code> means all extensionProperties defined in the external
   *     task activity will be provided. <code>false</code> means custom extension properties are
   *     not available within the external-task-client. The default is <code>false
   *     </code>.
   */
