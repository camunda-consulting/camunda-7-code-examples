 ...
 */
@JsonPropertyOrder({
  ProcessInstanceQueryDtoSorting.JSON_PROPERTY_SORT_BY,
  ProcessInstanceQueryDtoSorting.JSON_PROPERTY_SORT_ORDER
})
@JsonTypeName("ProcessInstanceQueryDto_sorting")
