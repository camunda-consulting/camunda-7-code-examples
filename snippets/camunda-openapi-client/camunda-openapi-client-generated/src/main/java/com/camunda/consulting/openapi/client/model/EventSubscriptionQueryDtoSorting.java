 ...
 */
@JsonPropertyOrder({
  EventSubscriptionQueryDtoSorting.JSON_PROPERTY_SORT_BY,
  EventSubscriptionQueryDtoSorting.JSON_PROPERTY_SORT_ORDER
})
@JsonTypeName("EventSubscriptionQueryDto_sorting")
