 ...
 */
@JsonPropertyOrder({
  VariableInstanceQueryDtoSorting.JSON_PROPERTY_SORT_BY,
  VariableInstanceQueryDtoSorting.JSON_PROPERTY_SORT_ORDER
})
@JsonTypeName("VariableInstanceQueryDto_sorting")
