...
that shows how to run Java Delegates as External Task implementations. 

This project has been generated by the Maven archetype
[camunda-archetype-demo-7.9.3-SNAPSHOT](http://docs.camunda.org/latest/guides/user-guide/#process-applications-maven-project-templates-archetypes).
...
<!-- HTML snippet for index page
  <tr>
    <td><img src="snippets/remote-process-engine/src/main/resources/process.png" width="100"></td>
    <td><a href="snippets/remote-process-engine">Java Process Application for a Remote Camunda BPM Engine</a></td>
    <td>A Process Application for [Camunda BPM](http://docs.camunda.org).</td>
  </tr>
-->
<!-- Tweet
New @Camunda example: Java Process Application for a Remote Camunda BPM Engine - A Process Application for [Camunda BPM](http://docs.camunda.org). https://github.com/camunda-consulting/code/tree/master/snippets/remote-process-engine
-->