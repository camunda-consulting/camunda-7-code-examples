package com.camunda.demo.remote_command_executor;
...
public class ArquillianTest {
  ...
  public static WebArchive createDeployment() {
    ...
    return ShrinkWrap
            .create(WebArchive.class, "remote-command-executor.war")
            ...
            .addPackages(false, "com.camunda.demo.remote_command_executor") // not recursive to skip package 'nonarquillian'
