...
public class ArquillianTest {
  ...
  public static WebArchive createDeployment() {
    ...
    return ShrinkWrap
            .create(WebArchive.class, "extended-serialization-process.war")
            ...
            .addPackages(false, "com.camunda.consulting.extendedSerializationProcess") // not recursive to skip package 'nonarquillian'
