...
public class MyCamelRouteBuilder extends RouteBuilder {
	...
	public void configure() throws Exception {
		...
		from("twitter://search?sinceId=" + lastTweetId + "&type=polling&delay=60000&keywords=camunda&consumerKey="
				+ consumerKey + "&consumerSecret=" + consumerSecret + "&accessToken=" + token + "&accessTokenSecret="
				+ tokenSecret) //
						.routeId("twitter") //
						.to("log:org.camunda.demo.camel?level=INFO&showAll=true&multiline=true") // logging
						.transform()
