package com.camunda.consulting.processApplication;
...
public class ArquillianTest {
  ...
  private static final String PROCESS_DEFINITION_KEY = "process-application-war";
  ...
  public static WebArchive createDeployment() {
    ...
    return ShrinkWrap
            .create(WebArchive.class, "process-application-war.war")
            ...
            .addPackages(false, "com.camunda.consulting.processApplication") // not recursive to skip package 'nonarquillian'
