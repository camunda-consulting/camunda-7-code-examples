package org.camunda.bpm.demo.loan_request_handling;
...
public class ArquillianTest {
  ...
  public static WebArchive createDeployment() {
    ...
    return ShrinkWrap
            .create(WebArchive.class, "loan-request-handling.war")
            ...
            .addPackages(false, "org.camunda.bpm.demo.loan_request_handling") // not recursive to skip package 'nonarquillian'
